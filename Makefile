...
-s EXPORTED_FUNCTIONS="['_web_audio_buffer', '_amy_play_message', '_amy_start_web', '_amy_sample_rate', '_malloc', '_free']" \
...
SOURCES = src/bestline.c \
    src/algorithms.c src/amy.c src/envelope.c \
